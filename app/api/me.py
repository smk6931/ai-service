...
from app.services.items import get_character_equipment, get_character_inventory
...
def get_me(request: CharacterInfoRequest, db: Session = Depends(get_db)):
    ...
    if character:
        ...
        inventory_info = get_character_inventory(InventoryGetRequest(character_id=character.character_id), db)
