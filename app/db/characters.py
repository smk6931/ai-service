from sqlalchemy import Column, String, Enum, DateTime, ForeignKey, func, Integer, Float
...
class CharacterStats(Base):
    ...
    character_id = Column(UUID(as_uuid=True), ForeignKey("characters.character_id", ondelete="CASCADE"), nullable=False)
